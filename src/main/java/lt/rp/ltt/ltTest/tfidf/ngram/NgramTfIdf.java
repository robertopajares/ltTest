...
import lt.rp.ltt.ltTest.tfidf.TfIdf;
...
public class NgramTfIdf {
     ...
     * @throws IOException
     */
    public static void watchForNewDocuments(String[] args,Logger logger)throws IOException {
    	
    	logger.info("Starting watchForNewDocuments .......................................................");       
...
//            System.out.println(termStatistics(tfIdf));
            logger.info(termStatistics(tfIdf));  
        }
        logger.info("\n\n\n\n"); 
    }
}
